...
public class MyFindPopupDirectoryChooser extends JPanel {
    @NotNull
    private final MyFindUIHelper myHelper;
    @NotNull private final Project myProject;
    @NotNull private final MyFindPopupPanel myFindPopupPanel;
    @NotNull private final ComboBox<String> myDirectoryComboBox;

    @SuppressWarnings("WeakerAccess")
    public MyFindPopupDirectoryChooser(@NotNull MyFindPopupPanel panel) {
        ...
        MyFindPopupDirectoryChooser.MyRecursiveDirectoryAction recursiveDirectoryAction = new MyFindPopupDirectoryChooser.MyRecursiveDirectoryAction();
