...
public class MyFindInProjectUtil {

    private static final int USAGES_PER_READ_ACTION = 100;

    private MyFindInProjectUtil() {}
    ...
    public static void findUsages(@NotNull final FindModel findModel,
                                  ...
                                  @NotNull final Processor<? super UsageInfo> consumer) {
        Runnable runnable = () -> new MyFindInProjectTask(findModel, project, filesToStart, true).findUsages(processPresentation, consumer);
    ...
    public static void findUsages(@NotNull final FindModel findModel,
                                  ...
                                  @NotNull final Set<? extends VirtualFile> filesToStart,
                                  @NotNull final Processor<? super UsageInfo> consumer) {
        Runnable runnable = () -> new MyFindInProjectTask(findModel, project, filesToStart, false).findUsages(processPresentation, consumer);
...
//TODO really important
    ...
    public static class StringUsageTarget implements ConfigurableUsageTarget, ItemPresentation, DataProvider {
        ...
        public void findUsages() {
            com.intellij.find.findInProject.FindInProjectManager.getInstance(myProject).startFindInProject(myFindModel);
        }
        ...
        public void showSettings() {
            ...
            com.intellij.find.findInProject.FindInProjectManager findInProjectManager = FindInProjectManager.getInstance(myProject);
